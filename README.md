Just pull the script and add execution rights to it (chmod +x decrypt-cc.sh). Then execute the script (bash decrypt-cc.sh or ./decrypt-cc.sh (if you are already in the same path of the script)).
